...
/*   Updated: 2024/08/01 11:43:41 by bthomas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
* c (converted to a char) in the string pointed to by str.
*/
...
/*
* Appends string src to the end of dst. It will append at most size
...
* by addr with the constant byte c.
*/
void	*ft_memset(void *addr, int c, size_t n);

/*
* Erases the data in the n bytes of the memory
* starting at the location pointed to by addr by
...
* create a new string (with malloc(3)) resulting
